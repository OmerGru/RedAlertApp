import {
  StyleSheet, View, Text, ScrollView, TouchableOpacity, TextInput, Modal, Pressable, ActivityIndicator,
} from 'react-native';
          ...
          {watchedList.length === 0 ? (
            ...
            watchedList.map((city) => (
              <View key={city} style={styles.watchedRow}>
                <View style={styles.rowRightGroup}>
                  <Ionicons name="location-outline" size={16} color="#ff3b30" style={{ marginLeft: 10 }} />
          ...
          <View style={styles.modalOverlay}>
            ...
            >
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>{t('settings.addLocation')}</Text>
              ...
              <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.modalScroll} bounces={true}>
                {loadingCities ? (
...
const styles = StyleSheet.create({
  ...
  rowRightGroup: { flexDirection: 'row', alignItems: 'center' },
  settingIcon: {
    width: 30, height: 30, borderRadius: 8,
    backgroundColor: 'rgba(255,59,48,0.12)',
    alignItems: 'center', justifyContent: 'center', marginLeft: 12,
  },
  settingLabel: { color: '#ebebf5', fontSize: 15, textAlign: 'right' },
  settingValue: { color: '#636366', fontSize: 14, textAlign: 'left' },
  ...
  watchedCity: { color: '#ebebf5', fontSize: 15, textAlign: 'right', marginLeft: 5 },
  ...
  availableCity: { color: '#ebebf5', fontSize: 16, textAlign: 'right' },
  modalOverlay: {
  ...
  modalHeader: {
    ...
    padding: 20, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#2c2c2e',
  },
